...
<body>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-3">
    <p>&copy; 2024 MED SAP. All rights reserved. BY KALIKIRI VAISHNAVI</p>
  </footer>
...
<body>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 MED SAP. All rights reserved.  KALIKIRI VAISHNAVI</p>
  </footer>
  <body background="back.png" style="background-repeat: no-repeat; background-size: cover;">
...
![alt text](about.png)
![alt text](pro.png)
![alt text](<Screenshot 2024-05-09 235524.png>)
## RESULT:
